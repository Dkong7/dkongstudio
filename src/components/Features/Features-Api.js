const data = [
  ...
  {
    id: 2,
    image: "https://img.icons8.com/external-flatart-icons-outline-flatarticons/64/000000/external-audio-audio-and-video-flatart-icons-outline-flatarticons.png",
    title: "Producción de Audio",
    desc: "Cuento con una especialidad en Audio y Música, con más de una década trabajando en diversos escenarios y en estudios, he realizado piezas sonoras para todo tipo de formatos",
  },
  {
    id: 3,
